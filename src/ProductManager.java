...
public class ProductManager {
	...
	public List<Product> getActiveProductsSortedByPrice() {
		...
		return products.values().stream().filter(product -> ProductStatus.ACTIVE.equals(product.getProductStatus()))
				.sorted(Comparator.comparingDouble(product -> product.getPrice())).toList();
	...
	public double calculateAveragePriceInCategory(String category) {
		...
		double average = products.values().stream().filter(product -> product.getCategory().equals(category))
				.collect(Collectors.averagingDouble(Product::getPrice));
		OptionalDouble o = OptionalDouble.of(average);
	...
	public Map<String, Double> getCategoryPriceSum() {
		...
		return products.values().stream().collect(Collectors.groupingBy(Product::getCategory,
